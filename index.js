...
const INDEX_TEXT = {
  fr: {
    title: "Prières usuelles",
    morning: "Prière du matin",
    evening: "Prière du soir",
    ben: "Benedicite – Gratias – Angelus",
    rosary: "Rosaire",
    penance: "Pénitence",
    communion: "Communion",
    mass: "Sainte Messe",
  ...
  eu: {
    title: "Ohiko othoitzak",
    morning: "Goizeko othoitza",
    evening: "Arratseko othoitza",
    ben: "Benedicite – Gratias – Angelus",
    rosary: "Arrosarioa",
    penance: "Penitentzia",
    communion: "Kominiatzen delarik",
    mass: "Meza Saindua",
...
function saveGeneralLanguage(lang) {
  try {
...
function setText(lang) {
  ...
  document.title = t.title + " — Herria Bihotzean";
  ...
  document.querySelectorAll(".language-choice").forEach(b => {
    ...
    b.querySelector(".language-label").textContent =
      LABELS[lang][code];
  ...
  document.querySelectorAll("a[data-prayer]").forEach(a => {
    const u = new URL(a.getAttribute("href"), location.href);
    u.searchParams.set("ui", lang);
    a.href = u.pathname + u.search;
  });

  const back = document.querySelector("[data-main-back]");
  ...
  history.replaceState(
    null,
    "",
    location.pathname + "?lang=" + lang
  );
}

document.addEventListener("DOMContentLoaded", () => {
  let lang = readIncomingLanguage();
